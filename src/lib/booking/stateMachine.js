...
export function mapSessionState(step) {
  switch (step) {
    ...
    case CONVERSATION_STEPS.RESCHEDULING:
    case CONVERSATION_STEPS.MODIFYING:
      // Reschedule keeps the appointment's service — never drop to INIT / ASK_SERVICE.
    ...
    case CONVERSATION_STEPS.MODIFIED:
