...
const UI = {
  ...
  teamMember: { ro: 'Specialist', en: 'Specialist' },
  ...
  askServiceGreeting: { ro: 'Salut! 👋', en: 'Hi! 👋' },
  askServiceHint: {
    ro: 'Apasă *Servicii* și alege din listă (durată și preț apar la fiecare opțiune), sau scrie direct numele.',
    en: 'Tap *Services* and pick from the list (duration and price on each option), or type the name.',
  },
  ...
  bookedSeeYou: {
    ro: 'Te așteptăm! Dacă vrei să modifici sau anulezi, scrie oricând.',
    en: 'See you soon! To change or cancel, just message us anytime.',
  },
  bookedFooterReschedule: { ro: '*reprogramare*', en: '*reschedule*' },
  bookedFooterCancel: { ro: '*anulează*', en: '*cancel*' },
  hoursBookingInvite: {
    ro: 'Vrei să faci o programare? 😊',
    en: 'Want to book an appointment? 😊',
  },
  rescheduleConfirmYes: { ro: 'Da, mută', en: 'Yes, move it' },
  rescheduleConfirmNo: { ro: 'Nu, altceva', en: 'No, something else' },
  gdprTitle: { ro: 'Confidențialitate', en: 'Privacy' },
  gdprBody: {
    ro: 'Folosim datele pentru această programare și comunicări utile (inclusiv SMS).',
    en: 'We use your data for this booking and useful updates (including SMS).',
  },
  gdprStopSms: {
    ro: 'Oprești SMS-urile scriind *stop sms*.',
    en: 'Stop SMS by typing *stop sms*.',
  },
  gdprLink: { ro: 'Politica de confidențialitate', en: 'Privacy policy' },
  gdprContact: {
    ro: 'Detalii: scrie *contact*.',
    en: 'Details: type *contact*.',
  },
  ...
  rescheduledHint: {
    ro: 'Te așteptăm! Pentru alte modificări, scrie *reprogramare* sau *anulează*.',
    en: 'See you soon! For further changes, type *reschedule* or *cancel*.',
  },
  ...
  unknownServiceNotInList: {
    ro: 'Nu e printre serviciile noastre momentan, dar iată ce oferim:',
    en: "That isn’t among our services right now, but here’s what we offer:",
  },
  unknownServiceBody: {
    ro: '*{label}* nu e printre serviciile noastre momentan, dar iată ce oferim:',
    en: '*{label}* isn’t among our services right now, but here’s what we offer:',
  },
